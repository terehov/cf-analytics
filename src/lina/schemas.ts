...
export const SCHEMATA: Record<string, z.ZodTypeAny> = {
  ...
  // Die sieben Verkaufsstellen (M0, 0112) — dieselbe Huelle, anderer Filter.
  'getUmsatzbericht:vs_gesamtbetrieb':      UmsatzberichtSchema,
  'getUmsatzbericht:vs_ausser_haus':        UmsatzberichtSchema,
  'getUmsatzbericht:vs_amadeusgo':          UmsatzberichtSchema,
  'getUmsatzbericht:vs_cocktail_casino':    UmsatzberichtSchema,
  'getUmsatzbericht:vs_delivery':           UmsatzberichtSchema,
